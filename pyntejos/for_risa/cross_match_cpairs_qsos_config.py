...
max_tsep = 25, # (in Mpc) maximum transverse separation between the clusters.

#Parameters for the cross-match
max_dsep = 5,     # (in Mpc) maximum impact parameter between the cluster pair axis and the QSO sightline.
